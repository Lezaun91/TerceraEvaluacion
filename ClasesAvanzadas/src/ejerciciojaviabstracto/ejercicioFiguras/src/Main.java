package ejerciciojaviabstracto.ejercicioFiguras.src;
...
public class Main {
    public static void main(String[] args) {
      ...
      /*  Rectangulo rectangulo = new Rectangulo(p1, p2, p3, p4);
        ...
        Triangulo triangulo1 = new Triangulo(p1, p3, p4);
        System.out.println(triangulo1.calcularPerimetro());
        System.out.println("AREA");
        System.out.println(triangulo1.calcularArea());
        System.out.println(triangulo1.a());
        System.out.println(triangulo1.base());
        System.out.println(triangulo1.c());
    }
}